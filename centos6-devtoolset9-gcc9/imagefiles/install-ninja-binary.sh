...
if [ -f /imagefiles/ninja-${NINJA_VERSION}_x86_64-linux-gnu.tar.gz ];then
	ln -s /imagefiles/ninja-${NINJA_VERSION}_x86_64-linux-gnu.tar.gz ninja-${NINJA_VERSION}_x86_64-linux-gnu.tar.gz
else
